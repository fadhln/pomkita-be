...
import (
	...
	organizationapi "github.com/fadhln/pomkita-be/internal/httpapi/organization"
	...
	sessionapi "github.com/fadhln/pomkita-be/internal/httpapi/session"
	shiftapi "github.com/fadhln/pomkita-be/internal/httpapi/shift"
	stationapi "github.com/fadhln/pomkita-be/internal/httpapi/station"
	...
	usersapi "github.com/fadhln/pomkita-be/internal/httpapi/users"
...
func buildRouter(environment string, allowedOrigins []string, dependencies RouterDependencies) *gin.Engine {
	...
	if dependencies.LatestMigration == 0 {
		dependencies.LatestMigration = 18
	}
