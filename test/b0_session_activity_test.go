...
func resetB0SessionActivity(t *testing.T, conn *pgx.Conn) {
	...
	resetMigrations := []string{"000002_b0_request_context.down.sql", "000006_b1_drafts.down.sql", "000005_b1_shifts.down.sql", "000004_b1_catalog.down.sql", "000001_b0_foundation.down.sql"}
