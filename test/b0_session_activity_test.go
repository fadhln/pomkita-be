...
<<<<<<< HEAD
<<<<<<< HEAD
	resetMigrations := []string{"000002_b0_request_context.down.sql", "000006_b1_shifts.down.sql", "000005_b1_catalog.down.sql", "000001_b0_foundation.down.sql"}
=======
	resetMigrations := []string{"000002_b0_request_context.down.sql", "000007_b1_drafts.down.sql", "000006_b1_shifts.down.sql", "000005_b1_catalog.down.sql", "000001_b0_foundation.down.sql"}
>>>>>>> 5671439 (B1: add draft lease fencing and read procedure)
=======
	resetMigrations := []string{"000002_b0_request_context.down.sql", "000007_b1_submit.down.sql", "000007_b1_drafts.down.sql", "000006_b1_shifts.down.sql", "000005_b1_catalog.down.sql", "000001_b0_foundation.down.sql"}
>>>>>>> 45c3233 (B1: add atomic report submit and policy snapshots)
